...
Route::get('/olympiads/{olympiadId}/areas/{areaId}/phases/{phaseId}/level/{levelId}/scores', [PhaseController::class, 'getPhaseScoresByLevel']);
...
Route::get('/contestants/awarded/olympiads/{olympiadId}/areas/{areaId}/levels/{levelId}', [ContestantController::class, 'competitorsReadjustment']);
